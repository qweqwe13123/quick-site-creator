-- ============================================================================
--  Mytalora — full database setup for a FRESH Supabase project.
--  Run this once in: Supabase Dashboard → SQL Editor → New query → Run.
--  Safe to run on an empty project. Creates all tables, RLS policies, grants,
--  and the extensions used by the scheduled Telegram reports.
-- ============================================================================

-- ---- Extensions (for scheduled reports via pg_cron + pg_net) ---------------
...
-- ---- Visits (raw, used by /api/public/track) -------------------------------
