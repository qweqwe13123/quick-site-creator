...
export const Route = createFileRoute("/es/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Términos que rigen tu uso del sitio web y los servicios de Mytalora." },
    ],
  }),
  component: TermsPage,
});
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Public Sans', system-ui, sans-serif" }}>
      <header className="border-b border-zinc-200">
        <div className="max-w-3xl mx-auto px-6 py-5 flex items-center justify-between">
          <Link to="/es" className="flex items-center gap-2">
            <img src="/assets/mytalora-logo.png" alt="Mytalora" className="h-9 w-auto object-contain" />
            <span className="font-semibold text-zinc-900">Mytalora</span>
          </Link>
      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <p className="text-zinc-700 leading-relaxed mb-8 text-[15px]">
          Bienvenido a Mytalora. Al acceder o utilizar nuestro sitio web y servicios, aceptas estar sujeto a estos Términos de Uso.
        </p>

        <Section title="1. Nuestros servicios">
          <p>Mytalora ofrece revisiones profesionales de currículums, servicios de redacción de currículums, asistencia en preparación de entrevistas, orientación profesional y apoyo en la búsqueda de empleo.</p>
        ...
        <Section title="4. Responsabilidades del cliente">
          ...
          <p>Mytalora no es responsable de inexactitudes resultantes de información incompleta o incorrecta proporcionada por el cliente.</p>
        </Section>

        <Section title="5. Sin garantía de empleo">
          <p>Mytalora no garantiza:</p>
        ...
        <Section title="6. Propiedad intelectual">
          <p>Todo el contenido de este sitio web, incluyendo texto, gráficos, marca, logotipos y materiales, es propiedad de Mytalora y no puede ser copiado o distribuido sin permiso.</p>
          <p>Los clientes conservan la propiedad de su información personal e historial laboral.</p>
        </Section>

        <Section title="7. Limitación de responsabilidad">
          <p>En la máxima medida permitida por la ley, Mytalora no será responsable por daños indirectos, incidentales, especiales, consecuentes o punitivos derivados del uso de nuestros servicios.</p>
