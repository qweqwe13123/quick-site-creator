...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Terms governing your use of Mytalora's website and services." },
    ],
  }),
  component: TermsPage,
});
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Public Sans', system-ui, sans-serif" }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <p className="text-zinc-700 leading-relaxed mb-8 text-[15px]">
          Welcome to Mytalora. By accessing or using our website and services, you agree to be bound by these Terms of Use.
        </p>

        <Section title="1. Our Services">
          <p>Mytalora provides professional resume reviews, resume writing services, interview preparation assistance, career guidance, and job search support.</p>
        ...
        <Section title="4. Client Responsibilities">
          ...
          <p>Mytalora is not responsible for inaccuracies resulting from incomplete or incorrect information provided by the client.</p>
        </Section>

        <Section title="5. No Employment Guarantee">
          <p>Mytalora does not guarantee:</p>
        ...
        <Section title="6. Intellectual Property">
          <p>All content on this website, including text, graphics, branding, logos, and materials, is the property of Mytalora and may not be copied or distributed without permission.</p>
          <p>Clients retain ownership of their personal information and employment history.</p>
        </Section>

        <Section title="7. Limitation of Liability">
          <p>To the maximum extent permitted by law, Mytalora shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from the use of our services.</p>
