...
export const Route = createFileRoute("/es/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cómo Mytalora recopila, usa y protege tu información personal." },
    ],
  }),
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Public Sans', system-ui, sans-serif" }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <p className="text-zinc-700 leading-relaxed mb-8 text-[15px]">
          Mytalora respeta tu privacidad y se compromete a proteger tu información personal.
        </p>
        ...
        <Section title="3. Procesamiento de pagos">
          ...
          <p>Mytalora no almacena información completa de tarjetas de crédito en sus servidores.</p>
        </Section>
