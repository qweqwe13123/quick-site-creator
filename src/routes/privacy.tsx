...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Mytalora collects, uses, and protects your personal information." },
    ],
  }),
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Public Sans', system-ui, sans-serif" }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <p className="text-zinc-700 leading-relaxed mb-8 text-[15px]">
          Mytalora respects your privacy and is committed to protecting your personal information.
        </p>
        ...
        <Section title="3. Payment Processing">
          ...
          <p>Mytalora does not store full credit card information on its servers.</p>
        </Section>
